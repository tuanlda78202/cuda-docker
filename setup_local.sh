...
backup_configs() {
    ...
    for file in "$@"; do
        if [ -f "$HOME/$file" ]; then
            echo "Backing up existing $file to ${file}_backup_${timestamp}"
            mv "$HOME/$file" "$HOME/${file}_backup_${timestamp}"
        fi
    done
}
...
backup_configs .zshrc .p10k.zsh .tmux.conf
...
# Generated by Powerlevel10k configuration wizard on 2023-05-07 at 03:06 +07.
...
chmod 700 ~/.oh-my-zsh
chmod -R 700 ~/.oh-my-zsh/cache
chmod -R 700 ~/.oh-my-zsh/custom
chmod -R 700 ~/.oh-my-zsh/plugins
...
echo "Please:"
echo "1. Log out and log back in to start using ZSH as your default shell"
echo "2. Run 'p10k configure' if you want to customize your Powerlevel10k theme"
echo "3. Start tmux by typing 'tmux'"
echo "4. Inside tmux, you can use 'Ctrl+a' as the prefix key"
echo "5. Common tmux commands:"
echo "   - Split horizontally: Ctrl+a then -"
echo "   - Split vertically: Ctrl+a then |"
echo "   - Reload tmux config: Ctrl+a then r"
echo "   - Mouse mode is enabled for easy pane selection and scrolling"

# Source the new configurations
echo "Sourcing new configurations..."
source "$HOME/.zshrc"
